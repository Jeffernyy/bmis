    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header align-items-center">
          <h4 class="modal-title">Add Barangay Captain</h4>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input name="txt_add_captain_fname" class="form-control" type="text" id="firstName"
                  placeholder="Please enter your first name" autofocus>
              </div>
              <div class="form-group">
                <label class="form-label">Middle name</label>
                <input name="txt_add_captain_mname" class="form-control" type="text"
                  placeholder="Please enter your middle name">
              </div>
              <div class="form-group">
                <label class="form-label">Last name</label>
                <input name="txt_add_captain_lname" class="form-control" type="text"
                  placeholder="Please enter your last name">
              </div>
              <div class="form-group my-0">
                <label class="control-label">Username</label>
                <input name="txt_add_captain_uname" id="add_username" class="form-control" type="text"
                  placeholder="Please enter your username">
                <label id="add_user_msg"></label>
              </div>
              <div class="form-group">
                <label class="control-label">Password</label>
                <input name="txt_add_captain_upass" class="form-control" type="password"
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="custom-file">
                    <input name="txt_add_captain_image" type="file" class="custom-file-input" id="image_file">
  ...
  $(function () {
    ...
    $('#form').validate({
      rules: {
        ...
        txt_add_captain_fname: {
          required: true
        },
        txt_add_captain_mname: {
          required: true
        },
        txt_add_captain_lname: {
          required: true
        },
        txt_add_captain_uname: {
          required: true
        },
        txt_add_captain_upass: {
          required: true
        },
        txt_add_captain_image: {
          required: true
        },
      },
