    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header align-items-center">
          <h4 class="modal-title">Edit Government Office</h4>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="txt_edit_gov_office" class="form-control"
                      value="<?php echo htmlspecialchars($row['gov_office']) ?>" autofocus>
                  </div>
                </div>
              </div>
            </div>
