        ...
        <div class="content-wrapper">
          ...
          <section class="content-header">
            <div class="container-fluid">
              <div class="row mb-2">
                <div class="col-sm-6">
                  <h1 class="m-0">Manage Government Office</h1>
                </div>
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Manage Government Office</li>
                  </ol>
                </div>
              </div>
            </div>
                        ...
                        <table id="tblgovoffice" class="table table-bordered table-striped table-hover">
                          <thead>
                            <tr>
                              ...
                              <th class="align-middle">Government Office</th>
                              <th class="align-middle" width="290px">Added By</th>
                              <th class="align-middle" width="210px">Date Added</th>
                              <th class="align-middle" width="62px">Option</th>
                            </tr>
                          </thead>
                          <tbody>
                            <?php
                            $squery = mysqli_query($con, "SELECT * FROM tblgovoffice");
                            while ($row = mysqli_fetch_array($squery)) {
                              ...
                              echo '
                                <tr>
                                    ...
                                    <td class="align-middle">' . htmlentities(strtolower($row['gov_office'])) . '</td>
                                    <td class="align-middle">' . htmlentities($row['gov_office_added_by']) . '</td>
                                    <td class="align-middle">' . htmlentities($row['gov_office_date_added']) . '</td>
