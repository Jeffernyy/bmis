    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>Are you sure you want to disapprove this barangay clearance requested by
            <?php echo htmlspecialchars($row['clearance_requested_by']) ?> for his/her
            <?php echo htmlspecialchars($row['clearance_purpose']) ?> purpose? If yes, put the findings.
          </p>
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                ...
                <input name="txt_dis_clearance_findings" class="form-control" type="text"
