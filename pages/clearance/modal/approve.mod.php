    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>Do you wish to approve this barangay clearance requested by
            <?php echo $row['clearance_requested_by'] ?>
            for his/her
            <?php echo $row['clearance_purpose'] ?> purpose? If yes, please provide the necessary details.
          </p>
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                ...
                <input name="txt_app_clearance_num" class="form-control" type="number"
                  placeholder="Please enter your clearance number" autofocus>
              </div>
              <div class="form-group">
                <label class="control-label">Findings</label>
                <input name="txt_app_clearance_findings" class="form-control" type="text"
                  placeholder="Please enter your findings">
              </div>
              <div class="form-group">
                <label class="control-label">OR Number</label>
                <input name="txt_app_clearance_or_num" class="form-control" type="number"
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input name="txt_app_clearance_amount" class="form-control" type="number"
