<div class="modal fade" id="endModal<?php echo $row['pid']; ?>">
  <form method="post">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header align-items-center">
          <h4 class="modal-title">End Term Barangay Official</h4>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" name="btn_end" id="btn_end">Save changes</button>
        </div>
      </div>
    </div>
  </form>
