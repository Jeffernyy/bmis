    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header align-items-center">
          <h4 class="modal-title">Disapprove Low Income</h4>
        ...
        <div class="modal-body">
          ...
          <p>Are you sure you want to disapprove this certificate of low income requested by
            <?php echo htmlspecialchars($row['lowincome_requested_by']) ?>
            has annual income of
            <?php echo htmlspecialchars($row['lowincome_annual_income']) ?>? If yes, put the findings.
          </p>
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                ...
                <input name="txt_dis_lowincome_findings" class="form-control" type="text"
