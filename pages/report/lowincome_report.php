...
if (!isset($_SESSION)) {
  ...
  if (!isset($_SESSION['role'])) {
    ...
    if (isset($_POST['export_lowincome'])) { ?>
      ...
      <body>
        <div class="container">
          ...
          <h1 class="text-center text-uppercase text-bold font-italic mb-5">barangay lowincome report</h1>
          <div class="content">
            <!-- display the table data here from the lowincome report -->
            <h2>Daily Report</h2>
        ...
        <script>
          $(document).ready(function () {
            ...
            function populateTable(data, tableId, period) {
              ...
              switch (period) {
                case 'daily':
                  labels = data.daily_lowincome_labels || [];
                  requested = data.daily_lowincome_requested || [];
                  approved = data.daily_lowincome_approved || [];
                  disapproved = data.daily_lowincome_disapproved || [];
                  break;
                case 'weekly':
                  labels = data.weekly_lowincome_labels || [];
                  requested = data.weekly_lowincome_requested || [];
                  approved = data.weekly_lowincome_approved || [];
                  disapproved = data.weekly_lowincome_disapproved || [];
                  break;
                case 'monthly':
                  labels = data.monthly_lowincome_labels || [];
                  requested = data.monthly_lowincome_requested || [];
                  approved = data.monthly_lowincome_approved || [];
                  disapproved = data.monthly_lowincome_disapproved || [];
                  break;
                case 'yearly':
                  labels = data.yearly_lowincome_labels || [];
                  requested = data.yearly_lowincome_requested || [];
                  approved = data.yearly_lowincome_approved || [];
                  disapproved = data.yearly_lowincome_disapproved || [];
                  break;
              }
                  ...
                  },
                  {
                    ...
                    customize: function (doc) {
                      doc.content.splice(0, 0, {
                        text: 'Barangay Certificate of Lowincome Report',
                        style: 'header'
                      });
                    }
                  },
