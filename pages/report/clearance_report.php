...
if (!isset($_SESSION)) {
  ...
  if (!isset($_SESSION['role'])) {
    ...
    if (isset($_POST['export_clearance'])) { ?>
      ...
      <body>
        <div class="container">
          ...
          <h1 class="text-center text-uppercase text-bold font-italic mb-5">barangay clearance report</h1>
          <div class="content">
            <!-- display the table data here from the clearance report -->
            <h2>Daily Report</h2>
        ...
        <script>
          $(document).ready(function () {
            ...
            function populateTable(data, tableId, period) {
              ...
              switch (period) {
                case 'daily':
                  labels = data.daily_clearance_labels || [];
                  requested = data.daily_clearance_requested || [];
                  approved = data.daily_clearance_approved || [];
                  disapproved = data.daily_clearance_disapproved || [];
                  break;
                case 'weekly':
                  labels = data.weekly_clearance_labels || [];
                  requested = data.weekly_clearance_requested || [];
                  approved = data.weekly_clearance_approved || [];
                  disapproved = data.weekly_clearance_disapproved || [];
                  break;
                case 'monthly':
                  labels = data.monthly_clearance_labels || [];
                  requested = data.monthly_clearance_requested || [];
                  approved = data.monthly_clearance_approved || [];
                  disapproved = data.monthly_clearance_disapproved || [];
                  break;
                case 'yearly':
                  labels = data.yearly_clearance_labels || [];
                  requested = data.yearly_clearance_requested || [];
                  approved = data.yearly_clearance_approved || [];
                  disapproved = data.yearly_clearance_disapproved || [];
                  break;
              }
